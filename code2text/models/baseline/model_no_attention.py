...
class seq2seqTrain(tf.keras.Model):
    ...
    def _train_step(self, inputs):
        ...
        (input_tokens, target_tokens) = self._preprocess(input_text, target_text)
        ...
        with tf.GradientTape() as tape:
            ...
            for t in tf.range(max_target_length-1):
                ...
                step_loss, dec_state = self._loop_step(new_tokens, enc_output, dec_state)
                loss = loss + step_loss

            average_loss = loss / len(target_tokens)
